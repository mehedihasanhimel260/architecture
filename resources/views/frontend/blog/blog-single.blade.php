                    ...
                    <div class="blog-read">
                        <div class="post-content">
                            <div class="post-image">
                                <img src="{{ asset('frontend/assets') }}/images/blog/pic-blog-1.jpg" alt="" />
                            </div>
                            ...
                            <div class="post-text">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    ...
                                    in reprehenderit in voluptate velit esse cillum dolore eu fugiat. Lorem ipsum dolor sit
                                ...
                                <blockquote class="s1">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        ...
                        <div id="blog-comment">
                            ...
                            <ol>
                                <li>
                                    <div class="avatar">
                                        <img src="{{ asset('frontend/assets') }}/images/avatar.jpg" alt="" />
                                    </div>
                            ...
                            <div id="comment-form-wrapper">
                                ...
                                <div class="comment_form_holder">
                                    <form id="contact_form" name="form1" method="post" action="#">
                                        ...
                                        <p id="btnsubmit">
                                            <input type="submit" id="send" value="Send" class="btn btn-line" />
                                        </p>
                ...
                <div id="sidebar" class="col-md-4">
                    <div class="widget widget-post">
                        ...
                        <ul class="de-bloglist-type-1">
                            <li>
                                <div class="d-image">
                                    <img src="{{ asset('frontend/assets') }}/images/news-thumbnail/pic-blog-1.jpg" alt="">
                                </div>
                                <div class="d-content">
                            ...
                            <li>
                                <div class="d-image">
                                    <img src="{{ asset('frontend/assets') }}/images/news-thumbnail/pic-blog-2.jpg" alt="">
                                </div>
                                <div class="d-content">
                            ...
                            <li>
                                <div class="d-image">
                                    <img src="{{ asset('frontend/assets') }}/images/news-thumbnail/pic-blog-3.jpg" alt="">
                                </div>
                                <div class="d-content">
                            ...
                            <li>
                                <div class="d-image">
                                    <img src="{{ asset('frontend/assets') }}/images/news-thumbnail/pic-blog-4.jpg" alt="">
                                </div>
                                <div class="d-content">
                            ...
                            <li>
                                <div class="d-image">
                                    <img src="{{ asset('frontend/assets') }}/images/news-thumbnail/pic-blog-5.jpg" alt="">
                                </div>
                                <div class="d-content">
